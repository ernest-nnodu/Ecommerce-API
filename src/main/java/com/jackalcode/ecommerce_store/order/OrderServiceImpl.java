...
import com.jackalcode.ecommerce_store.exceptions.*;
...
public class OrderServiceImpl implements OrderService {
    ...
    public CheckoutResponse createOrder(CheckoutRequest checkoutRequest) {
        ...
        //Retrieve the current logged-in customer
        var currentCustomer = authenticationService.getCurrentCustomer();

        //Verify that the current logged-in customer is the owner of the cart
        ...
        //Generate order from the cart and persist to the database
